...
int main()
{
  ...
  Matrix<int> m5(m4);
  cout << "m5 should have the same data as m4" << endl;
  cout << m5 << endl;

  m5 = m3;
  cout << "m5 should have the same data as m3" << endl;
  cout << m5 << endl;

  Matrix<int> me; //making a matrix from the default constructor
  m5 = me;
  cout << "m5 should be empty." << endl;
  cout << m5 << endl;
